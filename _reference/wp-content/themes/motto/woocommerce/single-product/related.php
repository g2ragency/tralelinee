...
if ( $related_products ) :
	...
	?><section class="related products"><?php
		...
		$heading = apply_filters( 'woocommerce_product_related_products_heading', esc_html__( 'Related products', 'motto' ) );

		if ( $heading ) :
			?><h4><?php echo esc_html( $heading ); ?></h4><?php
		endif;

        ?><div class="wgl-products-related wgl-products-wrapper columns-<?php echo esc_attr($columns) . esc_attr( $carousel_class ); ?>"><?php
